...
class Testimonials {
    ...
    private static function shape( \WP_Post $post ): array {
        ...
        return [
            ...
            'clientName'     => html_entity_decode( get_post_meta( $post->ID, '_hpcms_client_name', true ) ),
            'clientPosition' => html_entity_decode( get_post_meta( $post->ID, '_hpcms_client_position', true ) ),
            'company'        => html_entity_decode( get_post_meta( $post->ID, '_hpcms_company', true ) ),
